            ...
            return (
              <article
                ...
                onClick={() => {
                  ...
                  navigate(`/lam-dao1320/projects/${project.id}`)
                }}
              >
                {/* Thumbnail */}
                    ...
                    <div className="flex gap-2">
                      {project.link && (
                        <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          className="flex gap-2 text-xs font-semibold px-2.5 py-1 rounded-md transition-colors duration-200"
                          style={{ background: "#F3F4F6", color: "#374151", fontFamily: "'Outfit', sans-serif" }}
                          onClick={e => e.stopPropagation()}
                          onMouseEnter={e => ((e.currentTarget as HTMLElement).style.background = "#E5E7EB")}
                          onMouseLeave={e => ((e.currentTarget as HTMLElement).style.background = "#F3F4F6")}
                        >
                          <project.link.Icon size={14} />{project.link.type}
                        </a>
                      )}
                      {project.demo && (
                        <a
