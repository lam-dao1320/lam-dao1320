        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="flex items-center gap-2 flex-wrap">
              {[
                { Icon: IoLocationSharp, text: profile.location },
                { Icon: IoIosMail, text: profile.email },
              ].map(({ Icon, text }) => (
                <span
                  key={text}
            ...
            <div className="flex gap-4 pt-1">
              {[
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex gap-2 text-sm font-semibold transition-colors duration-200"
                  style={{
                ...
                >
                  {label} <FaExternalLinkAlt className="pt-0.5" size={14}/>
                </a>
              ))}
            </div>
          </div>
          ...
          >
            <div className="flex justify-center lg:justify-end">
              <div className="relative float-anim">
                ...
                >
                  <img
                    src="/lam-dao1320/info/Profile.jpeg"
                    alt="Lam Dao"
